...
class Encuesta(models.Model):
    ...
    respuesta_1 = models.IntegerField(null=True, blank=True)
    pregunta_2 = models.CharField(max_length=100, null=True, blank=True)
    respuesta_2 = models.IntegerField(null=True, blank=True)
    pregunta_3 = models.CharField(max_length=100, null=True, blank=True)
    respuesta_3 = models.IntegerField(null=True, blank=True)
    pregunta_4 = models.CharField(max_length=100, null=True, blank=True)
    respuesta_4 = models.IntegerField(null=True, blank=True)
    pregunta_5 = models.CharField(max_length=100, null=True, blank=True)
    respuesta_5 = models.IntegerField(null=True, blank=True)
